...
/**
 * {@link OBOracleUKConstraintFactory}
 *
 * @author yh263208
 * @date 2023-11-27 19:42
 * @since ODC_release_4.2.3
 */
class OBOracleUKConstraintFactory extends AbstractUniqueConstraintFactory {

    private static final String LIST_CONSTRAINTS_COLS_KEY = "list-constraint-columns";

    public OBOracleUKConstraintFactory(@NonNull DataSource dataSource,
    ...
    protected void checkVirtualColumn(DataSource dataSource, ConstraintColumn constraintColumn) {
        ...
        Boolean result = new JdbcTemplate(dataSource).query(content, ps -> {
            ...
            ps.setString(2, constraintColumn.getTableName());
            ps.setString(3, constraintColumn.getColumnName());
        }, rs -> {
            try {
                ...
                return !"YES".equals(tableCol.getVirtualColumn());
