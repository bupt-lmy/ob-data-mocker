...
/**
 * Random data generator interface, used to generate random data, provides two interfaces for
 * implementation
 *
 * @author yh263208
...
public abstract class DigitalGeneratorBase<T extends Comparable> extends BaseGenerator<T, T> {
     ...
     * 数据生成方法接口
     *
     * @param minValue The minimum value has slightly different meanings for different types of data
     *        generators. For digital generation tasks, it reflects the minimum value of the generated
     *        numbers.
     * @param maxValue The maximum value has slightly different meanings for different types of data
     *        generators. For digital generation tasks, it reflects the maximum value of the generated
     *        numbers.
