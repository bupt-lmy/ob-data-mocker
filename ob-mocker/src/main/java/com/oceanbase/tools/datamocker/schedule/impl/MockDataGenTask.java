...
public class MockDataGenTask extends AbstractMockTask {
    ...
    public MockDataGenTask(TableTaskMetaData metaData, TableTaskContext context, MockerBuffer buffer,
        ...
        Validate.notNull(buffer, "Buffer for MockDataGenTask can not be null");
        Validate.notNull(readers, "Column readers for MockDataGenTask can not be null");
        Validate.notNull(constraints, "Constraints for MockDataGenTask can not be null");
        this.buffer = buffer;
    ...
    public void reloadConstraints(List<AbstractConstraint> constraints) {
        Validate.notNull(constraints, "Constraints can not be null for MockDataGenTask#setConstraints");
