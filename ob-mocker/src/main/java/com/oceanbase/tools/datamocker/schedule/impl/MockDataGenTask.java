...
/**
 * Mock data undertakes the task of actual data generation,
 * and the main logic is to generate data based on the generation primitives
 *
 * @author yh263208
...
public class MockDataGenTask extends AbstractMockTask {
    ...
    /**
     * Column constraint set, through the set to determine whether
     * the data generated by the column generation primitive meets the constraint
     */
    ...
    public Void execute(TableTaskMetaData metaData, TableTaskContext context) throws Exception {
        ...
        long counter = 0;
        // Cyclic idling counter, usually if idling exceeds totalCount and has not written any data, it is considered that the write is abnormal
