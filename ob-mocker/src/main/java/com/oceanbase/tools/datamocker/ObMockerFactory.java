...
public class ObMockerFactory extends AbstractMockerFactory {
    ...
    @Override
    public Dispatcher<TableTaskInfo> generate(AbstractTaskConfig taskConfig) throws Exception {
        ...
        Dispatcher<TableTaskInfo> dispatcher = new Dispatcher<>(tableConfigs.size(), taskName);
